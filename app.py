...
if 'final_data' in st.session_state:
    ...
    with st.expander("📖 How to read this Matrix"):
        ...
        * **Junior / Mid-level / Senior**: These columns represent the percentage of job postings at that level that require the skill.
        * **Junior_to_Senior_Diff**: The absolute change in market share. 
            * *Positive (+)*: This skill becomes significantly more important as you are promoted.
            * *Negative (-)*: This is a "Gatekeeper" skill—vital for entry but assumed or less emphasized at senior levels.
        * **Total_Rel_Change_Pct**: The growth rate of the skill's importance.
